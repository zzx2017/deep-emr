...
with open("rnn-word2vec-model.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("rnn-word2vec-model.h5")
...
json_file = open('rnn-word2vec-model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
loaded_model.load_weights("rnn-word2vec-model.h5")
