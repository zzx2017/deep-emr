...
for file in files:
    ...
    # encoded_annotations = [classes['I-' + x] for x in annotations]
    ...
    text_paths = ['../models/cnn/data/test/text/', '../models/rnn/data/test/text/', '../models/lstm/data/test/text/']
    labels_paths = ['../models/cnn/data/test/labels/', '../models/rnn/data/test/labels/', '../models/lstm/data/test/labels/']

    for i in range(len(text_paths)):
        write_text(text_paths[i] + file[13:-4] + '.txt', encoded_words)
        write_annotations(labels_paths[i] + file[13:-4] + '-labels.txt', encoded_annotations)
