...
for i in range(2, 96, 3):
	...
	entry = [label, tp, fp, fn, performance['Recall'], performance['Precision'], performance['F-measure']]
...
for i in range(96, 103):
	...
	fn = results[i][4]
	performance = evaluate(tp, fp, fn)
	entry = [results[i][0], tp, fp, fn, performance['Recall'], performance['Precision'], performance['F-measure']]
	indicator_level_results.append(entry)
